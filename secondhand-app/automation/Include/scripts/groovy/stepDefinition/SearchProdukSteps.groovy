...
class SearchProdukSteps {
//	@When("User buka aplikasi Secondhand")
//	public void userBukaAplikasiSecondhand() {
//	    
//	}
	...
	public void inputPadaSearchBar(String nameSearch) {
		WebUI.callTestCase(findTestCase('Page Objects/Search/inputFieldSearch'), [('expected') : nameSearch], FailureHandling.STOP_ON_FAILURE)
	}
